...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull ImageView photopreview,
      @NonNull TabLayout tabLayout, @NonNull TextView tv, @NonNull ViewPager viewPager) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, photopreview, tabLayout, tv,
          viewPager);
    }
