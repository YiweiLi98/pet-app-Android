...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof comp5216.sydney.edu.au.finalproject.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new comp5216.sydney.edu.au.finalproject.GlideOptions().apply(toSet));
    }
  }
}
